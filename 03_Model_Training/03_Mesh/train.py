...
data_dir = current_folder.parent / 'data' / '20260318_train_mesh'
...
def train():
    ...
    trainer = L.Trainer(accelerator='auto', devices=1, max_epochs=200, callbacks=callbacks, precision='16-mixed')
